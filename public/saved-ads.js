...
function generateAdAnalysis(adCount, reactCount, avgCreatives) {
  let text = `قام المعلن باختيار مكثف <b>(High hhhhhh Peak)</b> من خلال تفعيل <b>${adCount} إعلان نشط</b> بمتوسط <b>${avgCreatives} مشاهد إبداعية (Creatives)</b> للمنتج، ثم أوقف الإعلانات الخاسرة. ويركز الآن فقط على الإعلانات الرابحة لزيادة المبيعات <b>(Scaling)</b>. `;
